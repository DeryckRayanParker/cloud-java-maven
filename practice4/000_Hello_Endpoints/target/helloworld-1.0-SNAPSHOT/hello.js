...
function enableButtons () {
	...
	btn = document.getElementById("input_greet_hi");
	btn.onclick = function() {greetNew();};
	
	btn.value = "Click me for HI";
}
...
function greetNew() {
	var message = document.getElementById("hi").value;
	
	var request = gapi.client.helloworldendpoints.sendMessage({'message': message});
	request.execute(sayHelloCallback);
}
